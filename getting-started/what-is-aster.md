...
- **Spectators** — friends, family and fans who watch live, follow the
  ...
  account is needed.
- **Clubs and teams** — groups who ride together, run members-only rides, and
  keep a shared feed and route library.
- **Event organisers** — clubs and promoters who set up an event, distribute
  the route, run it on the day, and publish results.

## Live tracking, in one minute
...
4. When the athlete crosses the finish line (or taps Finish), their result is
   recorded and everything freezes at that moment.

## Sharing, not just tracking
...
- **Route distribution** — registering for an event downloads the route and
  map data to your phone, so navigation works even with no signal.

## What makes it different

- **It keeps working off-grid.** Endurance events happen in places with no
  phone signal. An athlete can start and finish with no signal at all — the
  app records everything on the phone and catches up automatically when
  signal returns. See [What happens when I lose signal?](../safety-and-offline/offline-and-no-signal.md)
- **Watching is open.** For public and unlisted events — and any ride shared
...
- Brand new? [Create an account](create-an-account.md) and read
  [Key concepts](key-concepts.md).
- Here to ride or run? Head to [For athletes](../for-athletes/).
- Here to watch? Head to [For spectators](../for-spectators/).
- Running an event? Head to [For organisers](../for-organisers/).
