...
- **The format and host lock once riders register.** Decide both before you open
  registration.

## After creating

You can edit most settings up to the start. Some lock once riders register (for
