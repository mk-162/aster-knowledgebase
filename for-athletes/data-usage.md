---
title: "Mobile data, battery and what runs offline"
parent: "For athletes"
nav_order: 3.5
audience: [athlete]
...
A common worry before a big day out: will tracking burn through my data or
battery? Here's the honest answer for a ride or a run.

## Data: tracking is light
...
If you're **watching** other people live — rather than being tracked yourself —
that streams a live map and updates continuously, so it uses more data, much like
any live-map app. On the move, prefer Wi-Fi for long watching sessions.
