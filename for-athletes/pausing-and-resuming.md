...
The status card turns amber and reads **Ride Paused** with a "Paused since…"
time, so a pause is never mistaken for a lost signal.
...
- Pausing is about **timing**, not safety. If you've had an accident, use **SOS**
...
- If the organiser set a cut-off time, being paused won't get you closed out at
  the cut-off — the app leaves paused riders alone. See
