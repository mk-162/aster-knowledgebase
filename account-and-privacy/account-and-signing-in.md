...
While signed in, go to **Settings → Account**. Enter your current password,
then your new one (at least 8 characters) twice, and tap **Change password**.

Forgotten it? Sign out and use **Forgot password?** on the sign-in screen to
get a reset link by email (see
...
Sign out from your profile. Signing out is **blocked while you're actively
tracking**, so you can't accidentally end up logged out mid-event. Finish or
stop your ride first.
