...
- Your profile, rides, GPS history, posts and follows are removed.
- Anything you posted that others might still see in a thread — a message,
  a comment — has its text replaced with **[deleted]** and is detached from
  you.
