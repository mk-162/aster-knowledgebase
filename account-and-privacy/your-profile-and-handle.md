...
- Links you add are checked for safety before they're shown.
- Changing your photo cleans up the old one automatically.
- Your athlete page lives at a web address based on your account, and
  people can also reach you through your @handle.
- To take your data with you or remove your account entirely, see
  [Export or delete your data](export-or-delete-your-data.md).

<!-- ## Unverified
- The precise athlete-page URL format is not surfaced to users in the KB (kept generic); the profile is reachable via @handle and from leaderboards/mentions.
-->
