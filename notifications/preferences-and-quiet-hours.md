---
title: "Preferences and quiet hours"
...
- **Events**: event reminders and announcements; new events from organisers you
  follow.
- **Clubs**: board posts; new rides or runs; ride or run reminders; ride or run
  chat.
...
**Safety alerts ignore quiet hours** and always come through.
...
- If you follow a lot of athletes in one race, the watching alerts (progress,
...
- The stoppage timer uses a default of about 15 minutes of no movement before it
  alerts, stored per athlete. There is no user-facing control to change that
